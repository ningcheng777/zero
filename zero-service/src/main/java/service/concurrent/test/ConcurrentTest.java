...
public class ConcurrentTest extends Thread {
    ...
    public ConcurrentTest(int thread_num, int client_num, String url, String postData) {
    ...
    public void run() {
        ...
        final ConcurrentTest currentObj = this;
...
//                new ConcurrentTest(i, j, url, "").run();
//            }
//        }
        String url = "http://localhost:8080/help-center-test/test/home?questionNum=2";
        new ConcurrentTest(500, 30, url, "").run();
